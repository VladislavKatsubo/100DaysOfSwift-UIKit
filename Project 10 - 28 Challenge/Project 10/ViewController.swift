...
class ViewController: UICollectionViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
//        KeychainWrapper.standard.set("arximo", forKey: "password")
        ...
        notificationCenter.addObserver(self, selector: #selector(protection), name: UIApplication.willResignActiveNotification, object: nil)
...
//                            let pc = UIAlertController(title: "Password", message: nil, preferredStyle: .alert)
//                            pc.addTextField()
//                            pc.addAction(UIAlertAction(title: "Check", style: .default) { [weak self] _ in
//                                guard let typedPassword = pc.textFields?[0].text else { return }
//                                if password == typedPassword {
//                                    self?.protected()
//                                }
//                            })
//                            pc.addAction(UIAlertAction(title: "Cancel", style: .cancel))
