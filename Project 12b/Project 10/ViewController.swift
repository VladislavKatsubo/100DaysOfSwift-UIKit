...
class ViewController: UICollectionViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        // it checks if there are some data for this key and if yes safely unwrapping it to the savedPeople variable with Data type and then decoding it to Person class.
    ...
    //function that allows us to encode people class data to an array and then write it to UserDefaults.
    func save() {
